...
from function.onnx_utils import load_chars_lao, ctc_decode_lao, preprocess_rec

PP_REC_MODEL = "model/lao_rec.onnx"
DICT_PATH = "dict/laos_dict_fn.txt"
IMAGE_PATH = "samples/img_12.png"
...
CHARS = load_chars_lao(DICT_PATH)
...
preds = session_rec.run(None, {input_name: rec_in})[0]
text, score = ctc_decode_lao(preds, CHARS)

plt.figure(figsize=(12, 6))
plt.title(f"Plate: {text} Score: {score}")
